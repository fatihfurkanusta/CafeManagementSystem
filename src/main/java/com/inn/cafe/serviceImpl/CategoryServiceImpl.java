...
public class CategoryServiceImpl implements CategoryService {
    ...
    private Category getCategoryFromMap(Map<String,String> requesetMap, boolean isAdd){
        Category category = new Category();
        if(isAdd){
            category.setId(Integer.parseInt(requesetMap.get("id")));
        }
        category.setName(requesetMap.get("name"));
        return category;
    }
